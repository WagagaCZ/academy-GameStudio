...
public class Deck {
    ...
    String path = "images/cards/"; //toto je vec tykajuca sa cisto weboveho rozhrania, teda nemalo by sa tu nic take nachadzat.. ja by som to dala do css stylov ako classy
